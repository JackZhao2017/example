 ...
 */
#ifndef __MESSAGE_CRC8_H_
#define __MESSAGE_CRC8_H_
...
#define DECLARE_CRC8_TABLE(_table) \
	static unsigned char  _table[CRC8_TABLE_SIZE]
 ...
 */
void crc8_populate_msb(unsigned char  table[CRC8_TABLE_SIZE], unsigned char  polynomial);
